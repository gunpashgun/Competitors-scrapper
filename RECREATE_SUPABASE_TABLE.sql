...
DROP TABLE IF EXISTS competitor_creatives CASCADE;
...
-- Allow all operations for service_role (your key)
CREATE POLICY "Allow all for service role" ON competitor_creatives
    FOR ALL
    USING (true)
    WITH CHECK (true);
